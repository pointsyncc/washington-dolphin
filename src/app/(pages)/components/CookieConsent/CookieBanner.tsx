...
export default function CookieBanner() {
  return (
    <CookieConsent
      ...
      overlay={true}
      overlayClasses="bg-[#e9e9e9] text-[#707070] text-[12px] px-4 py-2.5 flex items-center gap-2.5"
    ...
    >
      ...
      pogledati našu{' '}
      <Link href="/politika-privatnosti" className="underline font-semibold text-[#573400] text-[12px]">
        politiku privatnosti
      </Link>{' '}
      i{' '}
      <Link href="/uvjeti-poslovanja" className="underline font-semibold text-[#573400] text-[12px]">
        uvjete poslovanja
      </Link>
      .
    </CookieConsent>
