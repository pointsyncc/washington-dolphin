...
export const HomeHero = ({ heading, description, image, cta, galleryLink }: any) => {
  ...
  return (
    <Section
      ...
      containerProps={{
        className:
          'flex flex-col mt-8 lg:mt-0 lg:flex-row justify-between items-stretch space-y-6 space-y-reverse lg:space-y-0',
      }}
    >
      ...
      <div className="lg:w-1/2 lg:basis-1/2 max-w-[550px] lg:block flex justify-center pt-8 lg:pt-0*">
        <Image
          priority
          responsive={false}
          src={image.url}
